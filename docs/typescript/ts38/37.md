...
В случаях, в которых для вывода типов нужно составить условие на основе типов данных, прибегают к помощи знакомых по _JavaScript_ операторов: `typeof` и `instanceof`.
