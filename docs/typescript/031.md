...
Для повышения типобезопасности программы, правила накладываемые опцией `--strictNullChecks` (глава [Опции компилятора](060.md)), действуют также на переменные инициализирующихся в чужом контексте.
